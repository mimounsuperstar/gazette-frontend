...
import MusiqueThumbnail_Mars2023 from "../helpers/thumbnails/art_ivan_le_terrible_0323.jpg";
...
import SportThumbnail_Mars2023 from "../helpers/thumbnails/art_ivan_le_terrible_0323.jpg";
            ...
            <HomeWrapper>
                ...
                <HomeGrid>
                    ...
                    <HomeSection xAxis={"1/3"} yAxis={"16/18"} onClick={()=>redirect("videos/itv_mme_vauthier_0323")}>
                        ...
                        <TitleContainer>
                            <ArticleTitle>Interview: Mme. VAUTHIER répond à vos questions.</ArticleTitle>
                        </TitleContainer>
                    </HomeSection>
                </HomeGrid>
            </HomeWrapper>
